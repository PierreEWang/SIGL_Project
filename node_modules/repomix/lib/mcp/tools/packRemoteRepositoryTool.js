...
export const registerPackRemoteRepositoryTool = (mcpServer) => {
    ...
    }, (_a) => __awaiter(void 0, [_a], void 0, function* ({ remote, compress, includePatterns, ignorePatterns, topFilesLength, style }) {
        let tempDir = '';
        try {
            ...
            return yield formatPackToolResponse({ repository: remote }, packResult, outputFilePath, topFilesLength);
        }
        catch (error) {
