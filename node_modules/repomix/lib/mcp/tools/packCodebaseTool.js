...
export const registerPackCodebaseTool = (mcpServer) => {
    mcpServer.registerTool('pack_codebase', {
    ...
    }, (_a) => __awaiter(void 0, [_a], void 0, function* ({ directory, compress, includePatterns, ignorePatterns, topFilesLength, style, }) {
        let tempDir = '';
        try {
            ...
            return yield formatPackToolResponse({ directory }, packResult, outputFilePath, topFilesLength);
        }
        catch (error) {
