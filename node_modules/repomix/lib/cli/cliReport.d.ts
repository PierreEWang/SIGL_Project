 ...
 */
export declare const reportResults: (cwd: string, packResult: PackResult, config: RepomixConfigMerged) => void;
export declare const reportSummary: (packResult: PackResult, config: RepomixConfigMerged) => void;
...
//# sourceMappingURL=cliReport.d.ts.map